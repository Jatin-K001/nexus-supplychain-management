...
// and §14.7 (material assignments). Mirrors db/phaseTemplate.js exactly (used by
// the seed script) — kept as a TS copy here since apps/api's tsconfig rootDir
// can't reach outside apps/api/src for a real build.
...
const M = (name: string, qty: number): TemplateMaterial => ({ name, qty });

export const PHASES: TemplatePhase[] = [
  {
